...
const serviceCards: ServiceCard[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1519494080410-f9aa8f52f12b?auto=format&fit=crop&q=80&w=1400",
  },
  {
    title: "Surgical Care",
    description: "Modern theatre systems, perioperative safety protocols, and structured recovery pathways.",
    image:
      "https://images.unsplash.com/photo-1516549655669-df83a0774514?auto=format&fit=crop&q=80&w=1400",
  },
  {
      ...
      <main className={styles.main}>
        ...
        <section id="about" className={styles.about}>
          ...
          <div className={styles.aboutLayout}>
            ...
            <article className={styles.aboutBody} data-reveal>
              <p>
                We combine advanced clinical systems with a patient-first culture. Every service line is
                designed to reduce delay, strengthen decision quality, and preserve dignity.
              </p>
        ...
        <section id="services" className={styles.services}>
          <div className={styles.sectionHead} data-reveal>
            ...
            <h2>Specialized care domains, unified by speed and quality.</h2>
          </div>
          ...
          <div className={styles.servicesGrid}>
            {serviceCards.map((service) => (
              <article
                ...
                data-cursor="grow"
                style={{
                  backgroundImage: `linear-gradient(145deg, rgba(5, 26, 18, 0.86), rgba(8, 35, 26, 0.48)), url('${service.image}')`,
                }}
              >
                <h3>{service.title}</h3>
