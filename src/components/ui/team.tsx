    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div
          ...
          data-reveal
        >
          <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-[#2f8a66] text-white">
            <Stethoscope className="h-5 w-5" />
          </div>

          <h2 className="relative mb-4 text-4xl font-medium tracking-tight text-neutral-900 sm:text-5xl">
            Meet The Well Alive Doctors
            <svg
              ...
              >
                <div className="relative h-[17.5rem] w-full overflow-hidden rounded-2xl bg-neutral-100 sm:h-[20rem] md:h-[23rem]">
                  <img
                    ...
                    src={member.image}
                  />
                  <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#10382a]/80 via-[#2f8a66]/25 to-transparent opacity-65 transition-opacity duration-300 group-hover:opacity-95" />
        ...
        {featuredMember ? (
          <div className="mx-auto mt-20 max-w-3xl px-6 text-center lg:px-0" data-reveal>
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="relative h-14 w-14 overflow-hidden rounded-full ring-2 ring-[#2f8a66]/30">
                <img
