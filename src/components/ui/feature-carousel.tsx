  ...
  return (
    <div className="w-full max-w-7xl mx-auto md:p-8">
      <div className="relative overflow-hidden rounded-[2.5rem] lg:rounded-[4rem] flex flex-col lg:flex-row min-h-[600px] lg:aspect-video border border-border/40">
        <div className="w-full lg:w-[40%] min-h-[350px] md:min-h-[450px] lg:h-full relative z-30 flex flex-col items-start justify-center overflow-hidden px-8 md:px-16 lg:pl-16 bg-[#2f8a66]">
          <div className="absolute inset-x-0 top-0 h-12 md:h-20 lg:h-16 bg-gradient-to-b from-[#2f8a66] via-[#2f8a66]/80 to-transparent z-40" />
          <div className="absolute inset-x-0 bottom-0 h-12 md:h-20 lg:h-16 bg-gradient-to-t from-[#2f8a66] via-[#2f8a66]/80 to-transparent z-40" />
                ...
                >
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "bg-white text-[#2f8a66] border-white z-10"
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        isActive ? "text-[#2f8a66]" : "text-white/40"
                      )}
                    >
                      <HugeiconsIcon
                        icon={feature.icon}
