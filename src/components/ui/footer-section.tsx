...
export function Footer() {
  return (
    <footer className="relative w-full overflow-hidden border-t border-emerald-500/25 bg-[linear-gradient(160deg,#123822_0%,#0f2f1d_52%,#0a2416_100%)] text-emerald-50">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_40%_at_50%_0%,rgba(110,196,136,0.22),transparent_74%)]" />
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 py-12 md:px-10 lg:py-14">
        <div className="grid w-full gap-9 md:grid-cols-[1.3fr_1fr] md:gap-12">
          <AnimatedContainer className="space-y-5">
            ...
            <h3 className="text-2xl font-semibold tracking-tight">Well Alive Hospital</h3>
            ...
            <p className="pt-3 text-xs tracking-wide text-emerald-100/60">
